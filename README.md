...
多租户电商 SaaS：一个面板管理 Shopify / 抖音 / 淘宝 / 拼多多 / 京东 / Amazon 全渠道订单、库存、客户、优惠券、退款售后，经营健康引擎 + 千问 AI 深度分析。

> **v4.0 核心能力**：已接入真实 Shopify 店铺（Admin REST API），系统数据 100% 来自真实平台——商品、订单、客户、优惠券、退款全部自动同步落库，健康引擎/AI 在真实数据上运行。
...
完整更新历史见前端 **Changelog 页面**（官网底部 / Changelog 路由），最新版本 **v4.0**：真实 Shopify 接入、优惠券/退款真实同步、多项体验修复。
