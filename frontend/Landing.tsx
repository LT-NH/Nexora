...
const HeroConsole: React.FC = () => (
  <div className="relative float-y" style={{ animationDelay: '0.2s' }}>
    ...
    {/* Floating AI card */}
    <div
      className="absolute -bottom-10 -left-4 sm:-left-8 hidden sm:flex items-center gap-3 glass-card rounded-2xl px-4 py-3 shadow-xl shadow-violet-500/10"
      style={{ animation: 'floatY 8s ease-in-out 1.5s infinite' }}
    >
...
export const Landing: React.FC = () => {
  ...
  // 首页营销页固定浅色：进入时移除 dark class，离开时恢复用户主题选择
  useEffect(() => {
