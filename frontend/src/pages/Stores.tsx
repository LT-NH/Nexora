...
const D = {
  zh: {
    ...
    shopify_help_3: '3. 填写店铺 URL（如 https://your-store.myshopify.com）和 Access Token',
  ...
  en: {
    ...
    shopify_help_3: '3. Fill in the store URL (e.g. https://your-store.myshopify.com) and the Access Token',
